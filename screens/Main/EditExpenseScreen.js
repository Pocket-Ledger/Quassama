  ...
  const renderError = () => (
    <SafeAreaView className="flex-1 bg-white">
      <View className="items-center px-4 py-12">
        ...
        <TouchableOpacity className="px-6 py-3 rounded-lg bg-primary" onPress={loadExpenseData}>
        ...
        <View className="flex-1 ">
          ...
          <View className="input-group">
            ...
            {validationErrors.group && (
              <Text className="mt-1 text-sm text-red-500 error-text">{validationErrors.group}</Text>
            )}
          </View>
          ...
          <View>
            ...
            {validationErrors.note && (
              <Text className="mt-1 text-sm text-red-500 error-text">{validationErrors.note}</Text>
            )}
          </View>

          {/* Update Expense Button */}
          <TouchableOpacity
            className="py-4 mt-6 mb-8 rounded-lg btn-primary bg-primary"
