    ...
    <SafeAreaView className="flex-1 bg-white">
      ...
      <View className="flex-1 px-6 justify-between">
        ...
        <View className="flex-1 justify-center items-center pt-8">
          <Image
            source={require('../../assets/splashImgs/splash3.png')}
            style={{
              width: '90%',
              height: '85%',
              resizeMode: 'contain'
        ...
        <View className="pb-4">
          <Text className="text-2xl font-bold text-gray-900 text-center mb-4">
            Track, Split, Settle Fast
          </Text>
          <Text className="text-gray-500 text-center text-base leading-6 px-4">
            Add friends, family, or colleagues to your groups. Keep everyone on the same page for shared expenses.
          </Text>
        </View>
      </View>
